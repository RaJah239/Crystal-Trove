...
Primeape -> Fighting/Dark, moves pursuit, feint attack, Snarl, theif(?), throat chop, Annihilape’s stats or Mienshao's
...
;Exeggcute (Grass) -> D.Stone
;Exeggutor (Grass/Dragon) (replace this family.)

Mienfoo (Fighting) -> Lv36
Mienshao (Fighting)
