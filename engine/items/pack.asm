; Pack.Jumptable and BattlePack.Jumptable indexes
	...
	const PACKSTATE_INITMEDICINEPOCKET ; 13
	const PACKSTATE_MEDICINEPOCKETMENU ; 14
	const PACKSTATE_INITLOOTPOCKET     ; 15
	const PACKSTATE_LOOTPOCKETMENU     ; 16
	const PACKSTATE_QUITNOSCRIPT       ; 17
	const PACKSTATE_QUITRUNSCRIPT      ; 18
...
; entries correspond to PACKSTATE_* constants
	...
	dw .InitMedicinePocket ; 13
	dw .MedicinePocketMenu ; 14
	dw .InitLootPocket     ; 15
	dw .LootPocketMenu     ; 16
	dw Pack_QuitNoScript   ; 17
	dw Pack_QuitRunScript  ; 18
...
.LootPocketMenu:
	ld hl, LootPocketMenuHeader
	call CopyMenuHeader
	ld a, [wLootPocketCursor]
	ld [wMenuCursorPosition], a
	ld a, [wLootPocketScrollPosition]
	ld [wMenuScrollPosition], a
	call ScrollingMenu
	ld a, [wMenuScrollPosition]
...
; entries correspond to PACKSTATE_* constants
	...
	dw .InitBattlePocket   ; 11
	dw .BattlePocketMenu   ; 12
	dw .InitMedicinePocket ; 12
	dw .MedicinePocketMenu ; 13
	dw .InitLootPocket     ; 14
	dw .LootPocketMenu     ; 15
	dw Pack_QuitNoScript   ; 16
	dw Pack_QuitRunScript  ; 17
...
.LootPocket:
	ld a, LOOT_POCKET
	call InitPocket
	ld hl, PC_Mart_LootPocketMenuHeader
	call CopyMenuHeader
	ld a, [wLootPocketCursor]
	ld [wMenuCursorPosition], a
	ld a, [wLootPocketScrollPosition]
...
PackGFXPointers:
	...
	dw PackGFX + (15 tiles) * 6 ; MEDICINE_POCKET
	dw PackGFX + (15 tiles) * 7 ; LOOT_POCKET
...
; MEDICINE_POCKET
	...
	db $45, $46, $47, $48, $49 ; medicine text
	db $02, $05, $05, $05, $03 ; bottom border

; LOOT_POCKET
	db $00, $04, $04, $04, $01 ; top border
	db $4a, $4b, $4c, $4d, $4e ; loot text
	db $02, $05, $05, $05, $03 ; bottom border
