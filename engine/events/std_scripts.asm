...
BugContestResultsWarpScript:
	...
	setevent EVENT_TRAILWAY_PARK_GATE_OFFICER_CONTEST_DAY
	clearevent EVENT_TRAILWAY_PARK_GATE_OFFICER_NOT_CONTEST_DAY
	setevent EVENT_WARPED_FROM_ROUTE_35_NATIONAL_PARK_GATE
	warp TRAILWAY_PARK_GATE, 0, 4
