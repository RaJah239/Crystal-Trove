...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move BUG_BITE,     EFFECT_THIEF,              40, BUG,           PHYSICAL, 100, 24,   0
	...
	move TAUNT,        EFFECT_TAUNT,               0, DARK,          STATUS,   100, 24,   0
	...
	move ROCK_THROW,   EFFECT_NORMAL_HIT,         50, ROCK,          PHYSICAL,  95, 24,   0
	...
	move ROCK_BLAST,   EFFECT_MULTI_HIT,          25, ROCK,          PHYSICAL,  90, 16,   0
	move EARTHQUAKE,   EFFECT_EARTHQUAKE,        100, GROUND,        PHYSICAL, 100, 10,   0
	move FISSURE,      EFFECT_NORMAL_HIT,          1, GROUND,        PHYSICAL,  30,  5,   0
	...
	move HYPNOSIS,     EFFECT_SLEEP,               0, PSYCHIC_TYPE,  STATUS,    70, 24,   0
	move TRICK_ROOM,   EFFECT_TRICK_ROOM,          0, PSYCHIC_TYPE,  STATUS,   100, 16,   0
	...
	move AIR_SLASH,    EFFECT_FLINCH_HIT,         80, FLYING,        PHYSICAL, 100, 24,  20
	...
	move ROCK_SLIDE,   EFFECT_FLINCH_HIT,         75, ROCK,          PHYSICAL,  90, 24,  30
	...
	move FREEZE_DRY,   EFFECT_FREEZE_HIT,         70, ICE2,          SPECIAL,  100, 24,  10
	move OUTRAGE,      EFFECT_RAMPAGE,           120, DRAGON,        PHYSICAL, 100, 24,   0
	...
	move METEOR_MASH,  EFFECT_ATTACK_UP_HIT,     100, STEEL,         PHYSICAL,  85, 16,  20
