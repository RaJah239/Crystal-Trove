...
; ANIM_OBJ_U_TURN_LAUNCH
	battleanimobj RELATIVE_X, $90, BATTLE_ANIM_FRAMESET_EXPLOSION , BATTLE_ANIM_FUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_BLUE, $08
; ANIM_OBJ_U_TURN_RISE
	battleanimobj RELATIVE_X, $90, BATTLE_ANIM_FRAMESET_EXPLOSION , BATTLE_ANIM_FUNC_MOVE_UP, PAL_BATTLE_OB_BLUE, $08
; ANIM_OBJ_U_TURN_FALL
	battleanimobj RELATIVE_X, $90, BATTLE_ANIM_FRAMESET_EXPLOSION, BATTLE_ANIM_FUNC_DROP, PAL_BATTLE_OB_BLUE, $08
