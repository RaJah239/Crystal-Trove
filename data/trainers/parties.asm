...
if DEF(_DEBUG)
	...
	db 1, RAIKOU,   LEFTOVERS,     THUNDERBOLT, NO_MOVE, NO_MOVE, NO_MOVE
	db 1, PIKACHU,   BERRY,     THUNDERBOLT, NO_MOVE, NO_MOVE, NO_MOVE
	db 1, ENTEI,   NO_ITEM,     THUNDERBOLT, NO_MOVE, NO_MOVE, NO_MOVE
	db 1, SUICUNE,   NO_ITEM,     DOUBLE_EDGE, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end
else
