...
BrockGroup:
	...
	db 41, RHYHORN,    FURY_ATTACK, SCARY_FACE, EARTHQUAKE, TACKLE
...
BugCatcherGroup:
	...
	db 25, BEEDRILL,   FURY_ATTACK, FOCUS_ENERGY, TWINEEDLE, GUNK_SHOT
	...
	db 32, BEEDRILL,   FURY_ATTACK, PURSUIT, TWINEEDLE, DRAIN_PUNCH
