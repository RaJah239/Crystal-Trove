...
if DEF(_DEBUG)
	...
	db 100, PIKACHU,    U_TURN, QUICK_ATTACK, THUNDERBOLT, VOLT_SWITCH
	db 100, ESPEON,     U_TURN, REFLECT, VOLT_SWITCH, PSYCHIC_M
	db 100, SNORLAX,    VOLT_SWITCH, U_TURN, REST, BODY_SLAM
	db 100, VENUSAUR,   U_TURN, GIGA_DRAIN, SYNTHESIS, VOLT_SWITCH
	db 100, CHARIZARD,  FLAMETHROWER, WING_ATTACK, U_TURN, VOLT_SWITCH
	db 100, BLASTOISE,  U_TURN, SURF, BLIZZARD, VOLT_SWITCH
	db -1 ; end
else
