...
WillGroup:
	...
	db 4, XATU,       QUICK_ATTACK, BODY_SLAM, CONFUSE_RAY, PSYCHIC_M
	db -1 ; end
...
BrunoGroup:
	...
	db 4, MACHAMP,    ROCK_SLIDE, FORESIGHT, NO_MOVE, NO_MOVE
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_MOVES
	db 2, VILEPLUME,  STUN_SPORE, ACID, HEALING_LIGHT, RAZOR_LEAF
	db -1 ; end

KogaGroup:
	; KOGA (1)
	db "KOGA@", TRAINERTYPE_MOVES
	db 1, ARIADOS,    DRAIN_PUNCH, SPIDER_WEB, BATON_PASS, GIGA_DRAIN
	db -1 ; end

ChampionGroup:
	; CHAMPION (1)
	db "LANCE@", TRAINERTYPE_MOVES
	db 1, GYARADOS,   FLAIL, RAIN_DANCE, SURF, HYPER_BEAM
	db -1 ; end
