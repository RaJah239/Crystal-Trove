...
SchoolboyGroup:
	...
	db 35, QUAGSIRE,   TAIL_WHIP, AQUA_JET, AMNESIA, EARTHQUAKE
	db -1 ; end
...
LassGroup:
	...
	db 18, PSYDUCK,    AQUA_JET, TAIL_WHIP, DISABLE, CONFUSION
	db -1 ; end

	; LASS (14)
	db "DANA@", TRAINERTYPE_MOVES
	db 21, FLAAFFY,    AQUA_JET, GROWL, THUNDERSHOCK, THUNDER_WAVE
	db 21, PSYDUCK,    AQUA_JET, TAIL_WHIP, DISABLE, CONFUSION
	db -1 ; end
...
BeautyGroup:
	...
	db 17, HOPPIP,     HEALING_LIGHT, TAIL_WHIP, AQUA_JET, POISONPOWDER
	db 17, SKIPLOOM,   HEALING_LIGHT, TAIL_WHIP, AQUA_JET, STUN_SPORE
	db -1 ; end
...
SwimmerFGroup:
	...
	db 20, PSYDUCK,    AQUA_JET, TAIL_WHIP, DISABLE, CONFUSION
