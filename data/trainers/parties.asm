...
ClairGroup:
	...
	db 37, DRAGONAIR,  THUNDER_WAVE, SURF, AQUA_JET, DRAGONBREATH
	db 37, DRAGONAIR,  THUNDER_WAVE, THUNDERBOLT, AQUA_JET, DRAGONBREATH
	db 37, DRAGONAIR,  THUNDER_WAVE, ICE_BEAM, AQUA_JET, DRAGONBREATH
...
ScientistGroup:
	...
	db 30, PORYGON,    AQUA_JET, CONVERSION2, RECOVER, TRI_ATTACK
	db -1 ; end
