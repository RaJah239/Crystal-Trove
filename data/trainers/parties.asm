...
ClairGroup:
	...
	db 37, DRAGONAIR,  THUNDER_WAVE, SURF, TACKLE, DRAGONBREATH
	db 37, DRAGONAIR,  THUNDER_WAVE, THUNDERBOLT, TACKLE, DRAGONBREATH
	db 37, DRAGONAIR,  THUNDER_WAVE, ICE_BEAM, TACKLE, DRAGONBREATH
...
MistyGroup:
	...
	db 42, GOLDUCK,    SURF, DISABLE, TACKLE, PSYCHIC_M
...
ScientistGroup:
	...
	db 30, PORYGON,    TACKLE, CONVERSION2, RECOVER, TRI_ATTACK
	db -1 ; end
...
SchoolboyGroup:
	...
	db 35, QUAGSIRE,   TAIL_WHIP, TACKLE, AMNESIA, EARTHQUAKE
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 35, GOLDUCK,    CONFUSION, SCREECH, TACKLE, FURY_SWIPES
	db -1 ; end
	...
	db 31, QUAGSIRE,   WATER_GUN, TACKLE, AMNESIA, EARTHQUAKE
	...
	db 37, DRAGONAIR,  WRAP, SURF, DRAGON_RAGE, TACKLE
	db -1 ; end
...
BeautyGroup:
	...
	db 17, HOPPIP,     HEALING_LIGHT, TAIL_WHIP, TACKLE, POISONPOWDER
	db 17, SKIPLOOM,   HEALING_LIGHT, TAIL_WHIP, TACKLE, STUN_SPORE
	db -1 ; end
...
SwimmerFGroup:
	...
	db 21, HORSEA,     TACKLE, SMOKESCREEN, LEER, WATER_GUN
...
SailorGroup:
	...
	db 18, KRABBY,     TACKLE, LEER, NO_MOVE, NO_MOVE
...
BlackbeltGroup:
	...
	db 27, HITMONLEE,  DOUBLE_KICK, GROWL, TACKLE, FOCUS_ENERGY
	db -1 ; end
