...
ErikaGroup:
	...
	db 46, VICTREEBEL, SUNNY_DAY, MORNING_SUN, ACID, RAZOR_LEAF
...
CooltrainerFGroup:
	...
	db 25, SKIPLOOM,   MORNING_SUN, POISONPOWDER, MEGA_DRAIN, LEECH_SEED
...
BeautyGroup:
	...
	db 17, HOPPIP,     MORNING_SUN, TAIL_WHIP, TACKLE, POISONPOWDER
	db 17, SKIPLOOM,   MORNING_SUN, TAIL_WHIP, TACKLE, STUN_SPORE
	db -1 ; end
