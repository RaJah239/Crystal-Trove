...
FalknerGroup:
	...
	db  7, PIDGEY,     AQUA_JET, MUD_SLAP, NO_MOVE, NO_MOVE
	db  9, PIDGEOTTO,  AQUA_JET, MUD_SLAP, GUST, NO_MOVE
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 18, CLEFAIRY,   BUG_BITE, TACKLE, ENCORE, METRONOME
...
BugsyGroup:
	...
	db 14, METAPOD,    AQUA_JET, STRING_SHOT, HARDEN, NO_MOVE
	db 14, KAKUNA,     POISON_STING, STRING_SHOT, HARDEN, NO_MOVE
	db 16, SCYTHER,    QUICK_ATTACK, LEER, SHADOW_PUNCH, NO_MOVE
	db -1 ; end
...
MortyGroup:
	...
	db 21, HAUNTER,    HYPNOSIS, TACKLE, CURSE, NIGHT_SHADE
	db 25, GENGAR,     HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 23, HAUNTER,    SPITE, MEAN_LOOK, TACKLE, NIGHT_SHADE
	db -1 ; end
...
PryceGroup:
	...
	db 31, PILOSWINE,  ICY_WIND, TACKLE, MIST, BLIZZARD
	db -1 ; end
...
JasmineGroup:
	...
	db 30, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, NO_MOVE, THUNDER_WAVE
	db 35, STEELIX,    SCREECH, SUNNY_DAY, ROCK_THROW, SILVER_WIND
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_MOVES
	db 27, PRIMEAPE,   LEER, SURF, KARATE_CHOP, FURY_STRIKES
	db 30, POLIWRATH,  HYPNOSIS, KARATE_CHOP, SURF, METEOR_MASH
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 37, DRAGONAIR,  THUNDER_WAVE, SURF, AQUA_JET, DRAGON_PULSE
	db 37, DRAGONAIR,  THUNDER_WAVE, THUNDERBOLT, AQUA_JET, DRAGON_PULSE
	db 37, DRAGONAIR,  THUNDER_WAVE, ICE_BEAM, AQUA_JET, DRAGON_PULSE
	db 40, KINGDRA,    SMOKESCREEN, SURF, HYPER_BEAM, DRAGON_PULSE
	db -1 ; end
...
WillGroup:
	...
	db 40, XATU,       QUICK_ATTACK, BODY_SLAM, CONFUSE_RAY, PSYCHIC_M
	db 41, JYNX,       BUG_BITE, LOVELY_KISS, ICE_PUNCH, PSYCHIC_M
	db 41, EXEGGUTOR,  REFLECT, LEECH_SEED, EGG_BOMB, PSYCHIC_M
	db 41, SLOWBRO,    CURSE, AMNESIA, BODY_SLAM, PSYCHIC_M
	db 42, XATU,       QUICK_ATTACK, BODY_SLAM, CONFUSE_RAY, PSYCHIC_M
	db -1 ; end
...
BrunoGroup:
	...
	db 42, HITMONTOP,  PURSUIT, QUICK_ATTACK, DIG, NO_MOVE
	db 42, HITMONLEE,  SWAGGER, DOUBLE_KICK, HI_JUMP_KICK, FORESIGHT
	db 42, HITMONCHAN, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
	db 43, ONIX,       TACKLE, EARTHQUAKE, SANDSTORM, ROCK_SLIDE
	db 46, MACHAMP,    ROCK_SLIDE, FORESIGHT, NO_MOVE, NO_MOVE
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_MOVES
	db 42, UMBREON,    TACKLE, CONFUSE_RAY, FAINT_ATTACK, MEAN_LOOK
	db 42, VILEPLUME,  STUN_SPORE, ACID, HEALING_LIGHT, RAZOR_LEAF
...
KogaGroup:
	...
	db 40, ARIADOS,    DRAIN_PUNCH, SPIDER_WEB, BATON_PASS, GIGA_DRAIN
	...
	db 44, CROBAT,     DRAIN_PUNCH, QUICK_ATTACK, WING_ATTACK, TOXIC
	db -1 ; end
...
ChampionGroup:
	...
	db 47, DRAGONITE,  THUNDER_WAVE, TACKLE, THUNDER, HYPER_BEAM
	db 47, DRAGONITE,  THUNDER_WAVE, TACKLE, BLIZZARD, HYPER_BEAM
...
BrockGroup:
	...
	db 41, RHYHORN,    TACKLE, SCARY_FACE, EARTHQUAKE, TACKLE
	db 42, OMASTAR,    BITE, SURF, PROTECT, SPIKE_CANNON
	db 44, ONIX,       TACKLE, ROCK_SLIDE, EARTHQUAKE, SANDSTORM
...
MistyGroup:
	...
	db 42, GOLDUCK,    SURF, DISABLE, AQUA_JET, PSYCHIC_M
...
LtSurgeGroup:
	...
	db 40, ELECTRODE,  SCREECH, DRAIN_PUNCH, SWIFT, EXPLOSION
	db 40, MAGNETON,   TACKLE, DRAIN_PUNCH, SWIFT, ZAP_CANNON
	db 40, ELECTRODE,  SCREECH, DRAIN_PUNCH, SWIFT, EXPLOSION
...
ScientistGroup:
	...
	db 30, PORYGON, AQUA_JET, TACKLE, RECOVER, PHOTON_BLAST
	db -1 ; end

ErikaGroup:
	; ERIKA (1)
	db "ERIKA@", TRAINERTYPE_MOVES
	db 42, TANGELA,    VINE_WHIP, TACKLE, GIGA_DRAIN, SLEEP_POWDER
	db 41, JUMPLUFF,   MEGA_DRAIN, LEECH_SEED, COTTON_SPORE, GIGA_DRAIN
	db 46, VICTREEBEL, SUNNY_DAY, HEALING_LIGHT, ACID, RAZOR_LEAF
	db 46, BELLOSSOM,  SUNNY_DAY, HEALING_LIGHT, RAZOR_LEAF, SOLARBEAM
	db -1 ; end
...
YoungsterGroup:
	...
	db 21, RATICATE,   DRAIN_PUNCH, QUICK_ATTACK, HYPER_FANG, SCARY_FACE
	db -1 ; end

	; YOUNGSTER (13)
	db "JOEY@", TRAINERTYPE_MOVES
	db 30, RATICATE,   DRAIN_PUNCH, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end
...
SchoolboyGroup:
	...
	db 35, ELECTRODE,  SCREECH, NO_MOVE, ROLLOUT, LIGHT_SCREEN
	db 35, GROWLITHE,  SUNNY_DAY, LEER, BODY_SLAM, FLAME_CHARGE
	...
	db 35, XATU,       PECK, NIGHT_SHADE, SWIFT, BODY_SLAM
	db 32, TANGELA,    POISONPOWDER, VINE_WHIP, TACKLE, MEGA_DRAIN
	db 32, YANMA,      QUICK_ATTACK, DRAIN_PUNCH, NO_MOVE, SUPERSONIC
	db 35, QUAGSIRE,   DRAIN_PUNCH, AQUA_JET, AMNESIA, EARTHQUAKE
	db -1 ; end
	...
	db 38, MAGNETON,   ZAP_CANNON, THUNDER_WAVE, TACKLE, SWIFT
	db -1 ; end
...
BirdKeeperGroup:
	...
	db 40, FARFETCH_D, TACKLE, TACKLE, FLY, SLASH
	db -1 ; end
	...
	db 38, PIDGEOT,    SWIFT, TACKLE, STEEL_WING, FLY
	db -1 ; end
...
LassGroup:
	...
	db 18, FLAAFFY,    AQUA_JET, GROWL, THUNDERSHOCK, THUNDER_WAVE
	db 18, PSYDUCK,    AQUA_JET, DRAIN_PUNCH, DISABLE, CONFUSION
	db -1 ; end

	; LASS (14)
	db "DANA@", TRAINERTYPE_MOVES
	db 21, FLAAFFY,    AQUA_JET, GROWL, THUNDERSHOCK, THUNDER_WAVE
	db 21, PSYDUCK,    AQUA_JET, DRAIN_PUNCH, DISABLE, CONFUSION
	db -1 ; end

	; LASS (15)
	db "DANA@", TRAINERTYPE_MOVES
	db 29, PSYDUCK,    AQUA_JET, DISABLE, CONFUSION, SCREECH
	db 29, AMPHAROS,   AQUA_JET, THUNDERSHOCK, THUNDER_WAVE, COTTON_SPORE
	db -1 ; end

	; LASS (16)
	db "DANA@", TRAINERTYPE_MOVES
	db 32, PSYDUCK,    AQUA_JET, DISABLE, CONFUSION, SCREECH
	db 32, AMPHAROS,   AQUA_JET, THUNDERPUNCH, THUNDER_WAVE, COTTON_SPORE
	db -1 ; end
...
JanineGroup:
	...
	db 39, VENOMOTH,   FORESIGHT, DRAIN_PUNCH, GUST, PSYCHIC_M
	db -1 ; end

CooltrainerMGroup:
	; COOLTRAINERM (1)
	db "NICK@", TRAINERTYPE_MOVES
	db 26, CHARMANDER, EMBER, SMOKESCREEN, TACKLE, SCARY_FACE
	db 26, SQUIRTLE,   TACKLE, WATER_GUN, BITE, CURSE
	...
	db 35, KINGLER,    BUBBLEBEAM, STOMP, NO_MOVE, PROTECT
	db 35, FLAREON,    NO_MOVE, QUICK_ATTACK, BITE, FIRE_SPIN
	db -1 ; end

	; COOLTRAINERM (7)
	db "GAVEN@", TRAINERTYPE_ITEM_MOVES
	db 39, VICTREEBEL, NO_ITEM,      GIGA_DRAIN, TOXIC, SLUDGE_BOMB, RAZOR_LEAF
	db 39, KINGLER,    KINGS_ROCK,   SURF, STOMP, NO_MOVE, BLIZZARD
	...
	db 35, GOLDUCK,    CONFUSION, SCREECH, AQUA_JET, FURY_STRIKES
	db -1 ; end
	...
	db 31, QUAGSIRE,   WATER_GUN, AQUA_JET, AMNESIA, EARTHQUAKE
	...
	db 27, CHARMELEON, EMBER, SMOKESCREEN, FLAME_CHARGE, SCARY_FACE
	db -1 ; end

	; COOLTRAINERM (20)
	db "DARIN@", TRAINERTYPE_MOVES
	db 37, DRAGONAIR,  WRAP, SURF, DRAGON_RAGE, AQUA_JET
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 36, PIKACHU,    QUICK_ATTACK, DRAIN_PUNCH, THUNDERBOLT, THUNDER
	db 32, BLASTOISE,  BITE, CURSE, SURF, RAIN_DANCE
	db -1 ; end

	; COOLTRAINERF (9)
	db "BETH@", TRAINERTYPE_MOVES
	db 36, RAPIDASH,   STOMP, FIRE_SPIN, TACKLE, AGILITY
	db -1 ; end
	...
	db 32, VENUSAUR,   BODY_SLAM, SLEEP_POWDER, RAZOR_LEAF, NO_MOVE
	db -1 ; end

	; COOLTRAINERF (12)
	db "BETH@", TRAINERTYPE_MOVES
	db 39, RAPIDASH,   STOMP, FIRE_SPIN, TACKLE, AGILITY
	db -1 ; end
	...
	db 43, RAPIDASH,   FOCUS_BAND,   STOMP, FIRE_SPIN, TACKLE, FIRE_BLAST
	db -1 ; end
	...
	db 38, STARMIE,    NO_ITEM,      DRAIN_PUNCH, PSYCHIC_M, WATERFALL, CONFUSE_RAY
	...
	db 33, HORSEA,     SMOKESCREEN, LEER, WHIRLPOOL, TACKLE
	db 33, HORSEA,     SMOKESCREEN, LEER, WHIRLPOOL, TACKLE
	db 35, SEADRA,     SWIFT, LEER, WATERFALL, TACKLE
	db -1 ; end
...
BeautyGroup:
	...
	db 16, MEOWTH,     AQUA_JET, GROWL, BITE, NO_MOVE
	db 16, MEOWTH,     AQUA_JET, GROWL, BITE, SLASH
	db -1 ; end

	; BEAUTY (16)
	db "VALERIE@", TRAINERTYPE_MOVES
	db 17, HOPPIP,     HEALING_LIGHT, DRAIN_PUNCH, AQUA_JET, POISONPOWDER
	db 17, SKIPLOOM,   HEALING_LIGHT, DRAIN_PUNCH, AQUA_JET, STUN_SPORE
	db -1 ; end
...
PokemaniacGroup:
	...
	db 36, PORYGON,    RECOVER, PSYCHIC_M, TACKLE, PHOTON_BLAST
	db -1 ; end
...
SabrinaGroup:
	...
	db 48, ALAKAZAM,   RECOVER, BODY_SLAM, PSYCHIC_M, REFLECT
	db -1 ; end
...
BugCatcherGroup:
	...
	db 25, BEEDRILL,   TACKLE, FOCUS_ENERGY, TWINEEDLE, GUNK_SHOT
	...
	db 32, BEEDRILL,   TACKLE, PURSUIT, TWINEEDLE, DRAIN_PUNCH
...
FisherGroup:
	...
	db 25, REMORAID,   TACKLE, PSYBEAM, AURORA_BEAM, BUBBLEBEAM
	db 25, REMORAID,   TACKLE, PSYBEAM, AURORA_BEAM, BUBBLEBEAM
	db -1 ; end
	...
	db 34, SEAKING,    SUPERSONIC, WATERFALL, FLAIL, TACKLE
	db 34, SEAKING,    SUPERSONIC, WATERFALL, FLAIL, TACKLE
	...
	db 39, SEAKING,    ENDURE, FLAIL, TACKLE, WATERFALL
	db -1 ; end

	; FISHER (25)
	db "TULLY@", TRAINERTYPE_MOVES
	db 34, SEAKING,    SUPERSONIC, RAIN_DANCE, WATERFALL, TACKLE
	db 34, SEAKING,    SUPERSONIC, RAIN_DANCE, WATERFALL, TACKLE
	db 37, QWILFISH,   ROLLOUT, SURF, PIN_MISSILE, BODY_SLAM
	db -1 ; end
...
SwimmerFGroup:
	...
	db 20, PSYDUCK,    AQUA_JET, DRAIN_PUNCH, DISABLE, CONFUSION
	db 22, GOLDEEN,    PECK, DRAIN_PUNCH, SUPERSONIC, HORN_ATTACK
	db -1 ; end
...
SailorGroup:
	...
	db 18, KRABBY,     AQUA_JET, LEER, NO_MOVE, NO_MOVE
	db 20, KRABBY,     BUBBLEBEAM, LEER, NO_MOVE, NO_MOVE
	db -1 ; end
	...
	db 38, POLIWRATH,  SURF, TACKLE, ICE_PUNCH, CLOSE_COMBAT
	db -1 ; end

	; SAILOR (13)
	db "STEELE@", TRAINERTYPE_MOVES
	db 28, POLIWRATH,  SURF, BODY_SLAM, ICE_PUNCH, RAIN_DANCE
	db -1 ; end
...
SuperNerdGroup:
	...
	db 39, SEADRA,     SMOKESCREEN, TACKLE, SURF, WATERFALL
	db -1 ; end

	; SUPER_NERD (14)
	db "MARKUS@", TRAINERTYPE_MOVES
	db 19, SLOWPOKE,   CURSE, WATER_GUN, GROWL, TACKLE
	db -1 ; end
...
BlaineGroup:
	...
	db 50, RAPIDASH,   QUICK_ATTACK, FIRE_SPIN, TACKLE, FIRE_BLAST
	db -1 ; end
...
BurglarGroup:
	...
	db 26, GROWLITHE,  ROAR, EMBER, LEER, BODY_SLAM
	db 24, KOFFING,    AQUA_JET, SMOG, SLUDGE, SMOKESCREEN
	db -1 ; end
...
BlackbeltGroup:
	...
	db 27, HITMONLEE,  DOUBLE_KICK, GROWL, AQUA_JET, FOCUS_ENERGY
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 33, KOFFING,    AQUA_JET, SLUDGE, SMOKESCREEN, HAZE
	...
	; EXECUTIVEM (3)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 30, KOFFING,    AQUA_JET, THROAT_CHOP, SLUDGE, SMOKESCREEN
	db 30, KOFFING,    AQUA_JET, THROAT_CHOP, SLUDGE, SMOKESCREEN
	db 30, KOFFING,    AQUA_JET, THROAT_CHOP, SLUDGE, SMOKESCREEN
	db 32, WEEZING,    AQUA_JET, EXPLOSION, SLUDGE, SMOKESCREEN
	db 30, KOFFING,    AQUA_JET, THROAT_CHOP, SLUDGE, SMOKESCREEN
	db 30, KOFFING,    AQUA_JET, SMOG, SLUDGE, SMOKESCREEN
	db -1 ; end
...
PsychicGroup:
	...
	db 17, SLOWPOKE,   AQUA_JET, GROWL, WATER_GUN, NO_MOVE
	...
	db 13, ABRA,       TELEPORT, NO_MOVE, NO_MOVE, NO_MOVE
	db 15, KADABRA,    TELEPORT, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end

	; PSYCHIC_T (8)
	db "PHIL@", TRAINERTYPE_MOVES
	db 24, NATU,       LEER, NIGHT_SHADE, BODY_SLAM, CONFUSE_RAY
	db 26, KADABRA,    DISABLE, PSYBEAM, RECOVER, BODY_SLAM
	db -1 ; end
...
PicnickerGroup:
	...
	db 16, PIKACHU,    THUNDERSHOCK, GROWL, QUICK_ATTACK, DRAIN_PUNCH
	db -1 ; end
	...
	db 31, CLEFAIRY,   ENCORE, SING, BUG_BITE, MINIMIZE
	db -1 ; end

	; PICNICKER (17)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 37, CLEFAIRY,   ENCORE, BUG_BITE, MINIMIZE, METRONOME
	db -1 ; end
	...
	; PICNICKER (20)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 20, CLEFAIRY,   ENCORE, SING, BUG_BITE, MINIMIZE
	db -1 ; end
	...
	db 32, NIDOKING,   EARTHQUAKE, DOUBLE_KICK, POISON_STING, SILVER_WIND
	db 32, NIDOQUEEN,  EARTHQUAKE, DOUBLE_KICK, DRAIN_PUNCH, BODY_SLAM
	db -1 ; end
...
ExecutiveFGroup:
	...
	db 32, VILEPLUME,  ABSORB, NO_MOVE, SLEEP_POWDER, ACID
	...
	db 23, GLOOM,      ABSORB, NO_MOVE, SLEEP_POWDER, ACID
...
TwinsGroup:
	...
	db 16, CLEFAIRY,   GROWL, ENCORE, BUG_BITE, METRONOME
	...
	db 35, DRATINI,    THUNDER_WAVE, TACKLE, FLAMETHROWER, HEADBUTT
	db 35, DRATINI,    THUNDER_WAVE, TACKLE, ICE_BEAM, HEADBUTT
	db -1 ; end
...
BlueGroup:
	...
	db 56, PIDGEOT,    QUICK_ATTACK, WHIRLWIND, WING_ATTACK, TACKLE
	db 54, ALAKAZAM,   DISABLE, RECOVER, PSYCHIC_M, REFLECT
	db 56, RHYDON,     TACKLE, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
	db 58, GYARADOS,   TACKLE, HYDRO_PUMP, RAIN_DANCE, HYPER_BEAM
...
GruntFGroup:
	...
	db 18, GLOOM,      ABSORB, NO_MOVE, STUN_SPORE, SLEEP_POWDER
	db -1 ; end
