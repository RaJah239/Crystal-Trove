...
; entries correspond to PHONE_* constants
	...
	phone CAMPER,       TODD1,                 TRAILWAY,                  ANYTIME, ToddPhoneCalleeScript,    ANYTIME, ToddPhoneCallerScript
	phone PICNICKER,    GINA1,                 TRAILWAY,                  ANYTIME, GinaPhoneCalleeScript,    ANYTIME, GinaPhoneCallerScript
