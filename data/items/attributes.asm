...
; BRIGHTPOWDER
	item_attribute 9800, HELD_BRIGHTPOWDER, 20, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; GREAT_BALL
...
; HP_UP
	item_attribute 3920, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; PROTEIN
	item_attribute 3920, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; IRON
	item_attribute 3920, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
...
; LEAF_STONE
	item_attribute 10000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; METAL_POWDER
	item_attribute 9800, HELD_METAL_POWDER, 10, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; NUGGET
...
; QUICK_CLAW
	item_attribute 9800, HELD_QUICK_CLAW, 60, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; PSNCUREBERRY
	item_attribute 10, HELD_HEAL_POISON, 0, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_PARTY, ITEMMENU_PARTY
; GOLD_LEAF
	item_attribute 1000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SOFT_SAND
	item_attribute 9800, HELD_GROUND_BOOST, 10, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SHARP_BEAK
	item_attribute 9800, HELD_FLYING_BOOST, 10, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; PRZCUREBERRY
	item_attribute 10, HELD_HEAL_PARALYZE, 0, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_PARTY, ITEMMENU_PARTY
; BURNT_BERRY
	item_attribute 10, HELD_HEAL_FREEZE, 0, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_PARTY, ITEMMENU_PARTY
; ICE_BERRY
	item_attribute 10, HELD_HEAL_BURN, 0, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_PARTY, ITEMMENU_PARTY
; POISON_BARB
	item_attribute 9800, HELD_POISON_BOOST, 10, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; KINGS_ROCK
	item_attribute 9800, HELD_FLINCH, 30, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BITTER_BERRY
	item_attribute 10, HELD_HEAL_CONFUSION, 0, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_PARTY
; MINT_BERRY
	item_attribute 10, HELD_HEAL_SLEEP, 0, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_PARTY, ITEMMENU_PARTY
; RED_APRICORN
...
; BIG_MUSHROOM
	item_attribute 1000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SILVERPOWDER
	item_attribute 9800, HELD_BUG_BOOST, 10, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLU_APRICORN
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SHINY_CHARM
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
...
; GRN_APRICORN
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CLEANSE_TAG
	item_attribute 9800, HELD_CLEANSE_TAG, 0, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MYSTIC_WATER
	item_attribute 9800, HELD_WATER_BOOST, 10, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; TWISTEDSPOON
	item_attribute 9800, HELD_PSYCHIC_BOOST, 10, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; WHT_APRICORN
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLACKBELT_I
	item_attribute 9800, HELD_FIGHTING_BOOST, 10, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLK_APRICORN
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_64
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; PNK_APRICORN
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLACKGLASSES
	item_attribute 9800, HELD_DARK_BOOST, 10, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SLOWPOKETAIL
	item_attribute 9800, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; PINK_BOW
	item_attribute 9800, HELD_NORMAL_BOOST, 10, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; STICK
	item_attribute 9800, HELD_NONE, 0, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SMOKE_BALL
	item_attribute 9800, HELD_ESCAPE, 0, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; NEVERMELTICE
	item_attribute 9800, HELD_ICE_BOOST, 10, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MAGNET
	item_attribute 9800, HELD_ELECTRIC_BOOST, 10, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MIRACLEBERRY
	item_attribute 10, HELD_HEAL_STATUS, 0, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_PARTY, ITEMMENU_PARTY
; PEARL
...
; EVERSTONE
	item_attribute 10000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SPELL_TAG
	item_attribute 9800, HELD_GHOST_BOOST, 10, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; RAGECANDYBAR
	item_attribute 300, HELD_NONE, 20, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
; GS_BALL
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLUE_CARD
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; MIRACLE_SEED
	item_attribute 9800, HELD_GRASS_BOOST, 10, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; THICK_CLUB
	item_attribute 9800, HELD_NONE, 0, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; FOCUS_BAND
	item_attribute 9800, HELD_FOCUS_BAND, 30, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_78
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ENERGYPOWDER
...
; HARD_STONE
	item_attribute 9800, HELD_ROCK_BOOST, 10, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LUCKY_EGG
	item_attribute 777, HELD_NONE, 0, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CARD_KEY
...
; ZINC
	item_attribute 3920, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; CHARCOAL
	item_attribute 9800, HELD_FIRE_BOOST, 10, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BERRY_JUICE
	item_attribute 9800, HELD_BERRY, 20, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_PARTY, ITEMMENU_PARTY
; SCOPE_LENS
	item_attribute 9800, HELD_CRITICAL_UP, 0, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_8D
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_8E
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; METAL_COAT
	item_attribute 9800, HELD_STEEL_BOOST, 10, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; DRAGON_FANG
	item_attribute 9800, HELD_DRAGON_BOOST, 10, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_91
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LEFTOVERS
	item_attribute 9800, HELD_LEFTOVERS, 10, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; OLD_AMBER
...
; HELIX_FOSSIL
    item_attribute 0, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MYSTERYBERRY
	item_attribute 10, HELD_RESTORE_PP, -1, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_PARTY, ITEMMENU_PARTY
; DRAGON_SCALE
	item_attribute 10000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BERSERK_GENE
	item_attribute 9800, HELD_NONE, 0, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
...
; SUN_STONE
	item_attribute 10000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; POLKADOT_BOW
	item_attribute 9800, HELD_FAIRY_BOOST, 10, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; POWER_GLOVE
	item_attribute 0, HELD_NONE, 0, CANT_TOSS, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; UP_GRADE
	item_attribute 2100, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BERRY
	item_attribute 10, HELD_BERRY, 10, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_PARTY, ITEMMENU_PARTY
; GOLD_BERRY
	item_attribute 10, HELD_BERRY, 30, CANT_SELECT, BATTLE_ITEMS, ITEMMENU_PARTY, ITEMMENU_PARTY
; SQUIRTBOTTLE
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; LANTERN
	item_attribute 0, HELD_NONE, 0, CANT_TOSS, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
...
; TM01
	item_attribute 0, HELD_NONE, 0, CANT_TOSS, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; TM02
	item_attribute 0, HELD_NONE, 0, CANT_TOSS, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; TM03
	item_attribute 0, HELD_NONE, 0, CANT_TOSS, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
