...
; wDailyFlags1
	...
	const ENGINE_DAILY_BUG_CONTEST_UNION_CAVE_LAPRAS_MT_MOON_SQUARE_CLEFAIRY_DAISYS_GROOMING
	const ENGINE_SWARM
...
; Trees
	const ENGINE_TREE_TEST

; wDailyFlags2
	const ENGINE_BUENAS_PASSWORD
	const ENGINE_DAILY_ROUTE_29_30_TREES
	const ENGINE_DAILY_ROUTE_31_VIOLET_TREES
	const ENGINE_DAILY_ROUTE_33_AZALEA_TREES
	const ENGINE_DAILY_ROUTE_35_36_TREES
	const ENGINE_DAILY_ROUTE_37_38_TREES
	const ENGINE_DAILY_ROUTE_39_42_TREES
	const ENGINE_DAILY_ROUTE_43_44_TREES

; wDailyFlags3
	const ENGINE_DAILY_ROUTE_45_46_TREES
	const ENGINE_DAILY_ROUTE_1_26_TREES
	const ENGINE_DAILY_PEWTER_ROUTE_8_TREES
	const ENGINE_DAILY_ROUTE_11_FUCHSIA_TREES
