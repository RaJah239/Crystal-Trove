...
; Crystal Trove events start here. (CT1)
	...
	const EVENT_TALKED_TO_MAXIMA_MT_SILVER_OUTSIDE
	const EVENT_MAXIMA_APPEAR_MT_SILVER_OUTSIDE
	const EVENT_UNION_CAVE_GROTTO_SANDSHREW_OW
	const EVENT_UNION_CAVE_GROTTO_MACHOP_OW
	const EVENT_UNION_CAVE_GROTTO_CUBONE_OW
	const EVENT_UNION_CAVE_GROTTO_WOOPER_OW
	...
	const EVENT_CIANWOOD_GROTTO_QWILFISH_OW
	const EVENT_CIANWOOD_GROTTO_LANTURN_OW
	const EVENT_CIANWOOD_GROTTO_MANTINE_OW
	const EVENT_CIANWOOD_GROTTO_SEAKING_OW
	const EVENT_CIANWOOD_GROTTO_OCTILLERY_OW
	const EVENT_ROUTE_29_GROTTO_PIDGEY
	const EVENT_ROUTE_29_GROTTO_HOPPIP
	const EVENT_ROUTE_29_GROTTO_LEDYBA
	const EVENT_ROUTE_29_GROTTO_SPINARAK
	const EVENT_ROUTE_29_GROTTO_HOOTHOOT
	const EVENT_DARK_CAVE_WEST_GROTTO_GEODUDE
	const EVENT_DARK_CAVE_WEST_GROTTO_TEDDIURSA
	const EVENT_DARK_CAVE_WEST_GROTTO_DIGLETT
	const EVENT_DARK_CAVE_WEST_GROTTO_ZUBAT
	const EVENT_DARK_CAVE_WEST_GROTTO_MARILL
	const EVENT_RUINS_OF_ALPH_GROTTO_XATU
	const EVENT_RUINS_OF_ALPH_GROTTO_GIRAFARIG
	const EVENT_RUINS_OF_ALPH_GROTTO_SMEARGLE
	const EVENT_RUINS_OF_ALPH_GROTTO_EEVEE
	const EVENT_RUINS_OF_ALPH_GROTTO_EXEGGCUTE
	const EVENT_ROUTE_32_GROTTO_EKANS
	const EVENT_ROUTE_32_GROTTO_SPEAROW
	const EVENT_ROUTE_32_GROTTO_VULPIX
	const EVENT_ROUTE_32_GROTTO_NIDORAN_M
	const EVENT_ROUTE_32_GROTTO_NIDORAN_F
	const EVENT_SLOWPOKE_WELL_GROTTO_SLOWPOKE
	const EVENT_SLOWPOKE_WELL_GROTTO_POLIWHIRL
	const EVENT_SLOWPOKE_WELL_GROTTO_RATICATE
	const EVENT_SLOWPOKE_WELL_GROTTO_WEEZING
	const EVENT_SLOWPOKE_WELL_GROTTO_MUK
	const EVENT_ILEX_FOREST_GROTTO_BUTTERFREE
	const EVENT_ILEX_FOREST_GROTTO_BEEDRILL
	const EVENT_ILEX_FOREST_GROTTO_PINECO
	const EVENT_ILEX_FOREST_GROTTO_ODDISH
	const EVENT_ILEX_FOREST_GROTTO_PARAS
	const EVENT_ROUTE_34_GROTTO_MEOWTH
	const EVENT_ROUTE_34_GROTTO_FURRET
	const EVENT_ROUTE_34_GROTTO_SNUBBULL
	const EVENT_ROUTE_34_GROTTO_KADABRA
	const EVENT_ROUTE_34_GROTTO_DROWZEE
	const EVENT_NATIONAL_PARK_GROTTO_SUNKERN
	const EVENT_NATIONAL_PARK_GROTTO_PSYDUCK
	const EVENT_NATIONAL_PARK_GROTTO_SCYTHER
	const EVENT_NATIONAL_PARK_GROTTO_PINSIR
	const EVENT_NATIONAL_PARK_GROTTO_VENONAT
	const EVENT_ROUTE_36_GROTTO_BELLSPROUT
	const EVENT_ROUTE_36_GROTTO_GROWLITHE
	const EVENT_ROUTE_36_GROTTO_GASTLY
	const EVENT_ROUTE_36_GROTTO_YANMA
	const EVENT_ROUTE_36_GROTTO_HOUNDOUR
	const EVENT_ROUTE_38_GROTTO_DODRIO
	const EVENT_ROUTE_38_GROTTO_RAPIDASH
	const EVENT_ROUTE_38_GROTTO_TAUROS
	const EVENT_ROUTE_38_GROTTO_MILTANK
	const EVENT_ROUTE_38_GROTTO_ELECTRODE
	const EVENT_MOUNT_MORTAR_1F_INSIDE_GROTTO_GLIGAR
	const EVENT_MOUNT_MORTAR_1F_INSIDE_GROTTO_MAGNETON
	const EVENT_MOUNT_MORTAR_1F_INSIDE_GROTTO_MAGCARGO
	const EVENT_MOUNT_MORTAR_1F_INSIDE_GROTTO_DUNSPARCE
	const EVENT_MOUNT_MORTAR_1F_INSIDE_GROTTO_MISDREAVUS
	const EVENT_ROUTE_42_GROTTO_LICKITUNG
	const EVENT_ROUTE_42_GROTTO_AIPOM
	const EVENT_ROUTE_42_GROTTO_STANTLER
	const EVENT_ROUTE_42_GROTTO_PRIMEAPE
	const EVENT_ROUTE_42_GROTTO_MURKROW
	const EVENT_ROUTE_42_GROTTO_TANGELA
	const EVENT_ROUTE_42_GROTTO_FARFETCH_D
	const EVENT_ROUTE_42_GROTTO_SKARMORY
	const EVENT_ROUTE_42_GROTTO_KANGASKHAN
	const EVENT_ROUTE_42_GROTTO_HERACROSS
	const EVENT_ICE_PATH_1F_GROTTO_DELIBIRD
	const EVENT_ICE_PATH_1F_GROTTO_SNEASEL
	const EVENT_ICE_PATH_1F_GROTTO_PILOSWINE
	const EVENT_ICE_PATH_1F_GROTTO_CLOYSTER
	const EVENT_ICE_PATH_1F_GROTTO_DEWGONG
	const EVENT_DARK_CAVE_BLACK_THORN_ENTRANCE_GROTTO_WOBBUFFET
	const EVENT_DARK_CAVE_BLACK_THORN_ENTRANCE_GROTTO_RHYDON
	const EVENT_DARK_CAVE_BLACK_THORN_ENTRANCE_GROTTO_KINGLER
	const EVENT_DARK_CAVE_BLACK_THORN_ENTRANCE_GROTTO_DONPHAN
	const EVENT_DARK_CAVE_BLACK_THORN_ENTRANCE_GROTTO_SUDOWOODO
	const EVENT_ROUTE_26_GROTTO_CHANSEY
	const EVENT_ROUTE_26_GROTTO_MR__MIME
	const EVENT_ROUTE_26_GROTTO_KANGASKHAN
	const EVENT_ROUTE_26_GROTTO_AMPHAROS
	const EVENT_ROUTE_26_GROTTO_SHUCKLE
	const EVENT_VICTORY_ROAD_GROTTO_LARVITAR
	const EVENT_DRAGONS_DEN_GROTTO_DRATINI
	const EVENT_WHIRL_ISLAND_GROTTO_KINGDRA
	const EVENT_WHIRL_ISLAND_GROTTO_CORSOLA
	...
	const EVENT_ELMS_LAB_SCARLET
	const EVENT_ILEX_FOREST_S_MUSHROOM
	const EVENT_ILEX_FOREST_L_MUSHROOM
...
; Phone events
	...
	const EVENT_MOUNTMORTARB1F_ZAPDOS
	...
	const EVENT_SILVER_CAVE_ITEM_ROOMS_MEWTWO
	const EVENT_BETH_ASKED_FOR_PHONE_NUMBER
	const_skip ; unused in Crystal
	const EVENT_JOSE_ASKED_FOR_PHONE_NUMBER
	const EVENT_RUINSOFALPHHOOHWORDROOM_MEW
	...
	const EVENT_BEAT_CELADON_ARCHER ; was unused in Crystal
	...
	const EVENT_BEAT_LAVRADIOTOWER1F_AGATHA ; was unused in Crystal
	...
	const EVENT_CIANWOOD_GYM_BLOCKER ; was unused in Crystal
...
; Decorations
	...
	const EVENT_DECO_GASTLY_DOLL
	const EVENT_DECO_CLOYSTER_DOLL
	const EVENT_DECO_MUK_DOLL
	...
	const EVENT_DECO_TENTACRUEL_DOLL
...
; More Johto story events
	...
	const_skip ; was EVENT_BEAT_RIVAL_IN_MT_MOON
...
; Johto people
	...
	const_skip ; presently unused in Crystal Trove (was EVENT_GUIDE_GENT_VISIBLE_IN_CHERRYGROVE)
...
; Kanto people
	...
	const_skip ; was EVENT_MT_MOON_RIVAL
