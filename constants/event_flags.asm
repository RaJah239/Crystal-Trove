...
; HMs items (EVENT_GOT_SEAKING_CALL is with the Johto itemballs)
...
; Rods
	...
	const EVENT_PLAYERS_MOM_INITIAL
; Johto story events
...
; Johto itemballs
	...
	const EVENT_GOLDENROD_UNDERGROUND_FOCUS_BAND
...
; Johto people
	...
	const EVENT_TRAILWAY_PARK_GATE_OFFICER_CONTEST_DAY
	const EVENT_TRAILWAY_PARK_GATE_OFFICER_NOT_CONTEST_DAY
