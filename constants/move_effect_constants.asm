; MoveEffectsPointers indexes (see data/moves/effects_pointers.asm)
	...
	const EFFECT_PSYCH_UP ; remove this
	...
	const EFFECT_DIG
	const EFFECT_FISSURE
	const EFFECT_BONE_CLUB
	const EFFECT_SAND_ATTACK
	const EFFECT_BONEMERANG
	const EFFECT_MUD_SLAP
	const EFFECT_BONE_RUSH
