...
; - scripts and events (see data/maps/scripts.asm)
	...
	map_const BATTLE_PLAZA_TRAILWAY_GATE,                   5,  4 ;  9
	...
	map_const BATTLE_PLAZA_RUINS_OF_ALPH_GATE,              5,  4 ; 16
	map_const TRAILWAY_PARK_GATE,                           5,  4 ; 17
	endgroup

	newgroup GOLDENROD                                            ; 11
	map_const TRAILWAY,                                    16, 17 ;  1
	...
	map_const TRAILWAY_DRIFTSEA_GATE,                    5,  4 ; 23
	...
	map_const BATTLE_PLAZA,                                35, 18 ; 16
	...
	map_const DRIFTSEA_POKECENTER_1F,                    5,  4 ;  5
