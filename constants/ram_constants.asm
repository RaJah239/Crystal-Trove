...
; wDailyFlags2::
	const_def
	const DAILYFLAGS2_MT_MOON_SQUARE_CLEFAIRY_F           ; 1
	const DAILYFLAGS2_UNION_CAVE_LAPRAS_F                 ; 2
	const DAILYFLAGS2_GOLDENROD_UNDERGROUND_GOT_HAIRCUT_F ; 3
	const DAILYFLAGS2_GOLDENROD_DEPT_STORE_TM27_RETURN_F  ; 4
	const DAILYFLAGS2_DAISYS_GROOMING_F                   ; 5
	const DAILYFLAGS2_INDIGO_PLATEAU_RIVAL_FIGHT_F        ; 6
	const DAILYFLAGS2_DAILY_GIFT_BERRY_F                  ; 7
	const DAILYFLAGS2_BUENAS_PASSWORD_F                   ; 8
	const DAILYFLAGS2_DAILY_ROUTE_29_BERRY                ; 9
	const DAILYFLAGS2_DAILY_ROUTE_29_APRICORN             ; 10
	const DAILYFLAGS2_DAILY_ROUTE_30_BERRY_1              ; 11
	const DAILYFLAGS2_DAILY_ROUTE_30_APRICORN_1           ; 12
	const DAILYFLAGS2_DAILY_ROUTE_30_BERRY_2              ; 13
	const DAILYFLAGS2_DAILY_ROUTE_30_APRICORN_2           ; 14
