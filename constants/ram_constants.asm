...
; wDailyFlags1::
	const_def
	const DAILYFLAGS1_KURT_MAKING_BALLS_F             ; 1
	const DAILYFLAGS1_BUG_CONTEST_UNION_CAVE_LAPRAS_MT_MOON_SQUARE_CLEFAIRY_DAISYS_GROOMING ; 2
	const DAILYFLAGS1_SWARM_F                         ; 3
	const DAILYFLAGS1_DAILY_GIFT_BERRY_F              ; 4
	const DAILYFLAGS1_CIANWOOD_PHOTOGRAPH             ; 5
	const DAILYFLAGS1_ILEX_FOREST_MUSHROOMS           ; 6
	const DAILYFLAGS1_GOLDENROD_UNDERGROUND_BARGAIN_F ; 7
	const DAILYFLAGS1_INDIGO_PLATEAU_RIVAL_FIGHT_F    ; 8
; Trees
	const DAILYFLAGS1_TREE_TEST                       ; 9
	
; wDailyFlags2::
	const_def
	const DAILYFLAGS2_BUENAS_PASSWORD_F
	const DAILYFLAGS2_ROUTE_29_30_TREES_F
	const DAILYFLAGS2_ROUTE_31_VIOLET_TREES_F
	const DAILYFLAGS2_ROUTE_33_AZALEA_TREES_F
	const DAILYFLAGS2_ROUTE_35_36_TREES_F
	const DAILYFLAGS2_ROUTE_37_38_TREES_F
	const DAILYFLAGS2_ROUTE_39_42_TREES_F
	const DAILYFLAGS2_ROUTE_43_44_TREES_F

; wDailyFlags3::
	const_def
	const DAILYFLAGS3_ROUTE_45_46_TREES_F
	const DAILYFLAGS3_ROUTE_1_26_TREES_F
	const DAILYFLAGS3_PEWTER_ROUTE_8_TREES_F
	const DAILYFLAGS3_ROUTE_11_FUCHSIA_TREES_F
	const DAILYFLAGS3_DAILY_UNUSED_1_F
	const DAILYFLAGS3_DAILY_UNUSED_2_F
	const DAILYFLAGS3_DAILY_UNUSED_3_F
	const DAILYFLAGS3_GOLDENROD_UNDERGROUND_GOT_HAIRCUT_F
