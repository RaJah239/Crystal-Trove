...
- Run anywhere by holding  B + D Pad, Surf faster by default
- Can't run past spinning trainers (can with the Bicycle)
- Double encounter rate when on Bicycle
...
- Press Down when buying items to get the maximum affordable quantity, not 99
...
- Show held items on wild and trainer Pokémon
- Can swap held items in Pokémon Party Menu
- Added 4th Stat page with caught Pokémon information, Effort Values
