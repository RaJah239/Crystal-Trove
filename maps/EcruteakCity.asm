...
EcruteakCity_MapScripts:
	...
	def_callbacks
    callback MAPCALLBACK_NEWMAP, EcruteakCityFlypointCallbackAndResetEcruteakGymTrainersCallback

EcruteakCityFlypointCallbackAndResetEcruteakGymTrainersCallback:
	checkflag ENGINE_FLYPOINT_ECRUTEAK
	iffalse .SetEcruteakFlyPoint
