...
Route29_MapScripts:
	...
	def_callbacks
	callback MAPCALLBACK_OBJECTS, Route29FruitTrees
...
Route29_MapEvents:
	...
	warp_event 55,  0, ROUTE_29_GROTTO, 1
	warp_event 55,  1, ROUTE_29_GROTTO, 2
	...
	object_event 49,  3, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route29Potion, EVENT_ROUTE_29_POTION
	object_event 24, 12, SPRITE_BERRY, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route29BerryTree, EVENT_ROUTE_29_BERRY
