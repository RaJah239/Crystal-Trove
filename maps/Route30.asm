...
Route30Fruittrees:
.Berry:
	checkflag ENGINE_DAILY_ROUTE_30_BERRY_1
	iftrue .NoBerry
...
.Apricorn:
	checkflag ENGINE_DAILY_ROUTE_30_APRICORN_1
	iftrue .NoApricorn
...
Route30BerryTree:
	...
	setflag ENGINE_DAILY_ROUTE_30_BERRY_1
...
Route30ApricornTree:
	...
	setflag ENGINE_DAILY_ROUTE_30_APRICORN_1
	writetext Route30FoundItemText
	playsound SFX_ITEM
	waitsfx
	itemnotify
