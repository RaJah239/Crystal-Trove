GoldenrodCity_MapEvents:
	...
	object_event 16,  9, SPRITE_LASS, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 2, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, GoldenrodCityLassScript, EVENT_GOLDENROD_CITY_CIVILIANS
...
.TeachMove:
	...
	special DisplayCoinCaseBalance
	writetextend GoldenrodCityMoveTutorComeBackAnytimeText

.Cancel:
	writetextend GoldenrodCityMoveTutorAnytimeThenText
...
GoldenrodCityNameRaterSign:
	jumptext GoldenrodCityPokeBrosSignText

GoldenrodCityPokeBrosSignText:
	text "#-BROS."
...
.GoExploreGoldenrodCity:
	writetextend GoldenrodCityYoungster1Text
