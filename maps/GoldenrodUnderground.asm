...
GoldenrodUnderground_MapEvents:
	...
	object_event  7, 25, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, GoldenrodUndergroundFocusBand, EVENT_GOLDENROD_UNDERGROUND_FOCUS_BAND
